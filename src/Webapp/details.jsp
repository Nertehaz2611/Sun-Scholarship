				...
				<div class="col-lg-12">
					<div class="breadcrumb__links">
						<a href="./home"><i class="fa fa-home"></i> Home</a> <a
							href="shop">Shop</a> <span>Details ${Sp.getTenSp() }</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
						...
						<div class="product__details__slider__content">
							<div class="product__details__pic__slider owl-carousel">
								<img data-hash="product-1" class="product__big__img"
									src="img/shop/${Sp.getAnh()}" alt=""> <img
				...
				<div class="col-lg-6">
					<div class="product__details__text">
						<h3>${Sp.getTenSp() }<span>Brand: Riot</span>
						</h3>
						<div class="rating">
						...
						<div class="product__details__price">
							$ ${Sp.getGia()}.0 <span>$ ${Sp.getGia2()}.0</span>
						</div>
						<p>${Sp.getMoTa() }</p>
						<div class="product__details__button">
							...
							<a href="addsp?maspadd=${Sp.getMaSp() }" class="cart-btn"><span class="icon_bag_alt"></span>
								Add to cart</a>
							<ul>
