                            ...
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__product">
                                    <ul>
                                        ...
                                        <c:forEach var="o" items="${listSpCheckOut }">
                                        <li>
                                        <a href="details?masp=${o.getMasp()}" style = "color: black;">${o.getID()}. ${o.getName()} </a>
                                          :   ${o.getSl() }
                                        <span>$ ${o.getSum() }.0</span>
                                        </li>
                                        </c:forEach>
                                    </ul>
                                </div>
