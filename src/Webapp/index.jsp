...
<body>
	...
	<form action="sigup" method="post">
		<div class="ctndankky">
			...
			<a>${loi}</a>
			<hr>
			<label for="user"><b>Username</b></label> <input class="son"
				type="text" placeholder="Username" name="user" required>

			<label for="psw"><b>Password</b></label> <input class="son"
				type="password" placeholder="Password" name="psw" required>

			<label for="psw-repeat"><b>Re-enter the password</b></label> <input
				class="son" type="password" placeholder="Re-enter the password"
				name="psw-repeat" required> <label for="email"><b>Email</b></label>
			<input class="son" type="text" placeholder="Email" name="email"
				required> <input type="checkbox" checked="checked"
				name="remember" style="margin-bottom: 15px"> Agree to the terms
	...
	<section class="product spad">
		<div class="container">
			...
			<div class="row property__gallery">
				<c:forEach var="o" items="${listPD}">
					<c:choose>
						<c:when
							test="${Integer.parseInt(o.getMaSp().substring(o.getMaSp().length() - 2)) % 2 == 0}">
							<div class="col-lg-3 col-md-4 col-sm-6 mix men">
								<div class="product__item">
									<div class="product__item__pic set-bg"
										data-setbg="img/product/${o.getAnh() }">
										<ul class="product__hover">
											<li><a href="img/product/${o.getAnh() }"
												class="image-popup"><span class="arrow_expand"></span></a></li>
											<li><a href="#"><span class="icon_heart_alt"></span></a></li>
											<li><a href="#"><span class="icon_bag_alt ${o.getMaSp()}"></span></a></li>
										</ul>
									</div>
									<div class="product__item__text">
										<h6>
											<a href="details?masp=${o.getMaSp()}">${o.getTenSp()}</a>
										</h6>
										<div class="rating">
										...
										<div class="product__price">$ ${o.getGia()}.0</div>
									</div>
								</div>
							</div>
						</c:when>
