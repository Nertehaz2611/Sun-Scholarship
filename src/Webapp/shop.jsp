...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb__links">
						<a href="./home"><i class="fa fa-home"></i> Home</a> <span>Shop</span>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-9 col-md-9">
					<div class="row">
						...
						<c:forEach var="o" items="${listSp}">
							<div class="col-lg-4 col-md-6 sanpham">
								<div class="product__item">
									<div class="product__item__pic set-bg"
										data-setbg="img/shop/${o.getAnh()}">
										<ul class="product__hover">
											<li><a href="img/shop/${o.getAnh()}" class="image-popup"><span
													class="arrow_expand"></span></a></li>
											<li><a href="delete?Masp=${o.getMaSp() }"><span class="icon_heart_alt"></span></a></li>
											<li><a><span class="icon_bag_alt ${o.getMaSp()}"></span></a></li>
										</ul>
									</div>
									<div class="product__item__text">
										...
										<div class="product__price giaSp">$ ${o.getGia()}.0</div>
									</div>
								</div>
							</div>
						</c:forEach>
						<div class="col-lg-12 text-center">
							<div class="pagination__option">
								<a  class = "trang">1</a> <a class = "trang">2</a> <a  class = "trang">3</a> <a
    ...
    <script src="js/tachtrang.js"></script>
